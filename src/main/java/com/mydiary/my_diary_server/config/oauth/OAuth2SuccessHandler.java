package com.mydiary.my_diary_server.config.oauth;
...
public class OAuth2SuccessHandler extends SimpleUrlAuthenticationSuccessHandler {
        ...
        String refreshToekn = tokenProvider.generateToken(user, REFRESH_TOKEN_DURATION);
        saveRefreshToken(user.getId(), refreshToekn);
        addRefreshTokenToCookie(request, response, refreshToekn);
