...
import com.mydiary.my_diary_server.repository.*;
...
public class DiaryService {
    ...
    public com.mydiary.my_diary_server.dto.ReportDTO createReport(String author, String comment)
    {
    	com.mydiary.my_diary_server.dto.ReportDTO report = new ReportDTO();
